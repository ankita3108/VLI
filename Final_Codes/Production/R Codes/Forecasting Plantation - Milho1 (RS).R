...
data <- read.csv("../Data Directory/Milho1 Plantation Input Files/Milho1_RS.csv", header = T, stringsAsFactors = FALSE)
str(data)
...
jpeg('../Data Directory/Plantation Plots/Milho1_RS.jpg')
...
write.csv(dataframe,file = "../Data Directory/Milho1 Plantation Output/Predicted-Plantation_RS.csv",row.names=FALSE)
