...
data <- read.csv("../Data Directory/Milho1 Plantation Input Files/Milho1_SP.csv", header = T, stringsAsFactors = FALSE)
str(data)
...
jpeg('../Data Directory/Plantation Plots/Milho1_SP.jpg')
...
write.csv(dataframe,file = "../Data Directory/Milho1 Plantation Output/Predicted-Plantation_SP.csv",row.names=FALSE)