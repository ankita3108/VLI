...
data <- read.csv("../Data Directory/Soya Plantation Input Files/Soya_SP.csv", header = T, stringsAsFactors = FALSE)
str(data)
...
jpeg('../Data Directory/Plantation Plots/Soya_SP.jpg')
...
write.csv(dataframe,file = "../Data Directory/Soya Plantation Output/Predicted-Plantation_SP.csv",row.names=FALSE)