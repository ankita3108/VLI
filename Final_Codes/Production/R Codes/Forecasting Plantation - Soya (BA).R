...
data <- read.csv("../Data Directory/Soya Plantation Input Files/Soya_BA.csv", header = T, stringsAsFactors = FALSE)
str(data)
...
jpeg('../Data Directory/Plantation Plots/Soya_BA.jpg')
...
write.csv(dataframe,file = "../Data Directory/Soya Plantation Output/Predicted-Plantation_BA.csv",row.names=FALSE)