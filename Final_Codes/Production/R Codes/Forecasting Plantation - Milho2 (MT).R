...
data <- read.csv("../Data Directory/Milho2 Plantation Input Files/Milho2_MT.csv", header = T, stringsAsFactors = FALSE)
str(data)
...
jpeg('../Data Directory/Plantation Plots/Milho2_MT.jpg')
...
write.csv(dataframe,file = "../Data Directory/Milho2 Plantation Output/Predicted-Plantation_MT.csv",row.names=FALSE)