...
data <- read.csv("../Data Directory/Milho1 Plantation Input Files/Milho1_PR.csv", header = T, stringsAsFactors = FALSE)
str(data)
...
jpeg('../Data Directory/Plantation Plots/Milho1_PR.jpg')
...
write.csv(dataframe,file = "../Data Directory/Milho1 Plantation Output/Predicted-Plantation_PR.csv",row.names=FALSE)
