...
data <- read.csv("../Data Directory/Soya Plantation Input Files/Soya_MA.csv", header = T, stringsAsFactors = FALSE)
str(data)
...
jpeg('../Data Directory/Plantation Plots/Soya_MA.jpg')
...
write.csv(dataframe,file = "../Data Directory/Soya Plantation Output/Predicted-Plantation_MA.csv",row.names=FALSE)