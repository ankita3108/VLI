...
agro_yearly_pred<-subset(agro_yearly, UF=='GO' & Produto=='Milho 1 Safra' & Type=='Producao' & Years>=max_year)
...
agro_monthly_act<-subset(agro_yearly, UF=='GO' & Produto=='Milho 1 Safra' & Type=='Producao' & Years==max_year & Month<=max_month)
...
routes <- read.csv("../Data Directory/Milho1 Input Files/Milho1_GO.csv", header = T, stringsAsFactors = FALSE)
...
jpeg('../Data Directory/Plots/Milho1_GO.jpg')
...
write.csv(dataframe,file="../Data Directory/Jan2019/Milho1_-_Production_Model_Re-Run_Results/Milho1 Predicted Production New Results/Predicted-Production_GO.csv",row.names = FALSE)
...
write.csv(new_dataframe,file="../Data Directory/Jan2019/Milho1_-_Production_Model_Re-Run_Results/Milho1 Predicted Production New Results/Predicted-Production_GO.csv",row.names = FALSE)
...
write.csv(confidence,file="../Data Directory/Jan2019/Milho1_-_Production_Model_Re-Run_Results/Milho1 Confidence New Results/Confidence_GO.csv",row.names = FALSE)
...
write.csv(confidence_new_data,file="../Data Directory/Jan2019/Milho1_-_Production_Model_Re-Run_Results/Milho1 Confidence New Results/Confidence_GO.csv",row.names = FALSE)