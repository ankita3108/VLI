...
data <- read.csv("../Data Directory/Soya Plantation Input Files/Soya_PR.csv", header = T, stringsAsFactors = FALSE)
str(data)
...
jpeg('../Data Directory/Plantation Plots/Soya_PR.jpg')
...
write.csv(dataframe,file = "../Data Directory/Soya Plantation Output/Predicted-Plantation_PR.csv",row.names=FALSE)