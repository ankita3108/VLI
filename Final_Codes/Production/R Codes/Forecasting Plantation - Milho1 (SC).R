...
data <- read.csv("../Data Directory/Milho1 Plantation Input Files/Milho1_SC.csv", header = T, stringsAsFactors = FALSE)
str(data)
...
jpeg('../Data Directory/Plantation Plots/Milho1_SC.jpg')
...
write.csv(dataframe,file = "../Data Directory/Milho1 Plantation Output/Predicted-Plantation_SC.csv",row.names=FALSE)
