...
data <- read.csv("../Data Directory/Soya Plantation Input Files/Soya_RO.csv", header = T, stringsAsFactors = FALSE)
str(data)
...
jpeg('../Data Directory/Plantation Plots/Soya_RO.jpg')
...
write.csv(dataframe,file = "../Data Directory/Soya Plantation Output/Predicted-Plantation_RO.csv",row.names=FALSE)
