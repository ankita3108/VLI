...
data <- read.csv("../Data Directory/Milho1 Plantation Input Files/Milho1_MA.csv", header = T, stringsAsFactors = FALSE)
str(data)
...
jpeg('../Data Directory/Plantation Plots/Milho1_MA.jpg')
...
write.csv(dataframe,file = "../Data Directory/Milho1 Plantation Output/Predicted-Plantation_MA.csv",row.names=FALSE)
