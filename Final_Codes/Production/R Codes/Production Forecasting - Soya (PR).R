...
agro_yearly_pred<-subset(agro_yearly, UF=='PR' & Produto=='Soja' & Type=='Producao' & Years>=max_year)
...
agro_monthly_act<-subset(agro_yearly, UF=='PR' & Produto=='Soja' & Type=='Producao' & Years==max_year & Month<=max_month)
...
routes <- read.csv("../Data Directory/Soya Input Files/Soya_PR.csv", header = T, stringsAsFactors = FALSE)
...
jpeg('../Data Directory/Plots/Soya_PR.jpg')
...
write.csv(dataframe,file="../Data Directory/Jan2019/Production_Re-Run_Results_-_Soya/Soya_Predicted_Production_New_Results/Predicted-Production_PR.csv",row.names = FALSE)
...
write.csv(new_dataframe,file="../Data Directory/Jan2019/Production_Re-Run_Results_-_Soya/Soya_Predicted_Production_New_Results/Predicted-Production_PR.csv",row.names = FALSE)
...
write.csv(confidence,file="../Data Directory/Jan2019/Production_Re-Run_Results_-_Soya/Soya_Confidence_New_Results/Confidence_PR.csv",row.names = FALSE)
...
write.csv(confidence_new_data,file="../Data Directory/Jan2019/Production_Re-Run_Results_-_Soya/Soya_Confidence_New_Results/Confidence_PR.csv",row.names = FALSE)