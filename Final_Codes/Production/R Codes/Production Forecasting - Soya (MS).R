...
routes <- read.csv("../Data Directory/Soya Input Files/Soya_MS.csv", header = T, stringsAsFactors = FALSE)
...
agro_yearly_pred<-subset(agro_yearly, UF=='MS' & Produto=='Soja' & Type=='Producao' & Years>=max_year)
...
agro_monthly_act<-subset(agro_yearly, UF=='MS' & Produto=='Soja' & Type=='Producao' & Years==max_year & Month<=max_month)
...
jpeg('../Data Directory/Plots/Soya_MS.jpg')
...
write.csv(dataframe,file="../Data Directory/Jan2019/Production_Re-Run_Results_-_Soya/Soya_Predicted_Production_New_Results/Predicted-Production_MS.csv",row.names = FALSE)
...
write.csv(new_dataframe,file="../Data Directory/Jan2019/Production_Re-Run_Results_-_Soya/Soya_Predicted_Production_New_Results/Predicted-Production_MS.csv",row.names = FALSE)
...
write.csv(confidence,file="../Data Directory/Jan2019/Production_Re-Run_Results_-_Soya/Soya_Confidence_New_Results/Confidence_MS.csv",row.names = FALSE)
...
write.csv(confidence_new_data,file="../Data Directory/Jan2019/Production_Re-Run_Results_-_Soya/Soya_Confidence_New_Results/Confidence_MS.csv",row.names = FALSE)