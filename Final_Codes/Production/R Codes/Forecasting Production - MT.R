...
agro_yearly_pred<-subset(agro_yearly, UF=='MT' & Produto=='Milho 2 Safra' & Type=='Producao' & Years>=max_year)
...
agro_monthly_act<-subset(agro_yearly, UF=='MT' & Produto=='Milho 2 Safra' & Type=='Producao' & Years==max_year & Month<=max_month)
...
data <- read.csv("../Data Directory/Milho2 Input Files/Milho2_MT.csv", header = T, stringsAsFactors = FALSE)
str(data)
...
jpeg('../Data Directory/Plots/Milho2_MT.jpg')
...
write.csv(dataframe,file = "../Data Directory/Jan2019/Milho2_Production_Model_Re-Run_Results/Milho2 Predicted Production New Results/Predicted-Production_MT.csv",row.names=FALSE)
...
write.csv(new_dataframe,file = "../Data Directory/Jan2019/Milho2_Production_Model_Re-Run_Results/Milho2 Predicted Production New Results/Predicted-Production_MT.csv",row.names=FALSE)
...
write.csv(confidence,file = "../Data Directory/Jan2019/Milho2_Production_Model_Re-Run_Results/Milho2 Confidence New Results/Confidence_MT.csv",row.names=FALSE)
...
write.csv(confidence_new_data,file = "../Data Directory/Jan2019/Milho2_Production_Model_Re-Run_Results/Milho2 Confidence New Results/Confidence_MT.csv",row.names=FALSE)