...
data <- read.csv("../Data Directory/Soya Plantation Input Files/Soya_MS.csv", header = T, stringsAsFactors = FALSE)
str(data)
...
jpeg('../Data Directory/Plantation Plots/Soya_MS.jpg')
...
write.csv(dataframe,file = "../Data Directory/Soya Plantation Output/Predicted-Plantation_MS.csv",row.names=FALSE)