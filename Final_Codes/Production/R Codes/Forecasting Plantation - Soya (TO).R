...
data <- read.csv("../Data Directory/Soya Plantation Input Files/Soya_TO.csv", header = T, stringsAsFactors = FALSE)
str(data)
...
jpeg('../Data Directory/Plantation Plots/Soya_TO.jpg')
...
write.csv(dataframe,file = "../Data Directory/Soya Plantation Output/Predicted-Plantation_TO.csv",row.names=FALSE)