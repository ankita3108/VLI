...
data <- read.csv("../Data Directory/Soya Plantation Input Files/Soya_PI.csv", header = T, stringsAsFactors = FALSE)
str(data)
...
jpeg('../Data Directory/Plantation Plots/Soya_PI.jpg')
...
write.csv(dataframe,file = "../Data Directory/Soya Plantation Output/Predicted-Plantation_PI.csv",row.names=FALSE)