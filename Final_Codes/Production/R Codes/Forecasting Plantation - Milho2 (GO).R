...
data <- read.csv("../Data Directory/Milho2 Plantation Input Files/Milho2_GO.csv", header = T, stringsAsFactors = FALSE)
str(data)
...
jpeg('../Data Directory/Plantation Plots/Milho2_GO.jpg')
...
write.csv(dataframe,file = "../Data Directory/Milho2 Plantation Output/Predicted-Plantation_GO.csv",row.names=FALSE)
