...
data <- read.csv("../Data Directory/Soya Plantation Input Files/Soya_SC.csv", header = T, stringsAsFactors = FALSE)
str(data)
...
jpeg('../Data Directory/Plantation Plots/Soya_SC.jpg')
...
write.csv(dataframe,file = "../Data Directory/Soya Plantation Output/Predicted-Plantation_SC.csv",row.names=FALSE)