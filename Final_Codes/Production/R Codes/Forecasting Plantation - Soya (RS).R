...
data <- read.csv("../Data Directory/Soya Plantation Input Files/Soya_RS.csv", header = T, stringsAsFactors = FALSE)
str(data)
...
jpeg('../Data Directory/Plantation Plots/Soya_RS.jpg')
...
write.csv(dataframe,file = "../Data Directory/Soya Plantation Output/Predicted-Plantation_RS.csv",row.names=FALSE)